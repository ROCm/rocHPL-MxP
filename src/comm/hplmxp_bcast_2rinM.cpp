...
template int HPLMXP_bcast_2rinM(double*  SBUF,
                                int      SCOUNT,
                                int      ROOT,
                                MPI_Comm COMM);

template int HPLMXP_bcast_2rinM(float*   SBUF,
                                int      SCOUNT,
                                int      ROOT,
                                MPI_Comm COMM);

template int HPLMXP_bcast_2rinM(__half*  SBUF,
                                int      SCOUNT,
                                int      ROOT,
                                MPI_Comm COMM);

template int HPLMXP_bcast_2rinM(hipblaslt_f8_fnuz*  SBUF,
                                int      SCOUNT,
                                int      ROOT,
                                MPI_Comm COMM);
