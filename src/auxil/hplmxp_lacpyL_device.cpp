...
__launch_bounds__(BLOCK_DIM) __global__
  ...
  if(complete_block) {
    ...
    if((4 * I + 0 > J) && (4 * I + 0 < M)) Bj[4 * I + 0] = hipblaslt_f8_fnuz{Aj[4 * I + 0]};
    if((4 * I + 1 > J) && (4 * I + 1 < M)) Bj[4 * I + 1] = hipblaslt_f8_fnuz{Aj[4 * I + 1]};
    if((4 * I + 2 > J) && (4 * I + 2 < M)) Bj[4 * I + 2] = hipblaslt_f8_fnuz{Aj[4 * I + 2]};
    if((4 * I + 3 > J) && (4 * I + 3 < M)) Bj[4 * I + 3] = hipblaslt_f8_fnuz{Aj[4 * I + 3]};
  }
}
...
__launch_bounds__(BLOCK_DIM) __global__
  ...
  if(complete_block) {
    ...
    if((4 * I + 0 > J) && (4 * I + 0 < M)) Bj[4 * I + 0] = float{Aj[4 * I + 0]};
    if((4 * I + 1 > J) && (4 * I + 1 < M)) Bj[4 * I + 1] = float{Aj[4 * I + 1]};
    if((4 * I + 2 > J) && (4 * I + 2 < M)) Bj[4 * I + 2] = float{Aj[4 * I + 2]};
    if((4 * I + 3 > J) && (4 * I + 3 < M)) Bj[4 * I + 3] = float{Aj[4 * I + 3]};
  }
}
