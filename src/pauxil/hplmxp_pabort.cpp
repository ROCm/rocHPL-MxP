...
void HPLMXP_pabort(int LINE, const char* SRNAME, const char* FORM, ...) {
  /*
   * Purpose
   * =======
   *
   * HPLMXP_pabort displays an error message on stderr and halts execution.
   *
   *
   * Arguments
   * =========
